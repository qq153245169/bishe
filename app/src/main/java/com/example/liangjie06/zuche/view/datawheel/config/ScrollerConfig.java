package com.example.liangjie06.zuche.view.datawheel.config;
...
import static com.example.liangjie06.zuche.view.datawheel.config.DefaultConfig.MAX_LINE;
...
public class ScrollerConfig {
    ...
    public WheelCalendar mCurCalndar = new WheelCalendar(System.currentTimeMillis()); // 当前日期
