package com.example.liangjie06.zuche.view.datawheel.data.source;


import com.example.liangjie06.zuche.view.datawheel.config.ScrollerConfig;
import com.example.liangjie06.zuche.view.datawheel.data.WheelCalendar;
...
public class TimeRepository implements TimeDataSource {
    ...
    public WheelCalendar getDefaultCalendar() {
        return mScrollerConfig.mCurCalndar;
    }
}
