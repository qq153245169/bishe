package com.example.liangjie06.zuche.view.hotcity;
...
import com.example.liangjie06.zuche.view.hotcity.dao.AllCitySqliteOpenHelper;
import com.example.liangjie06.zuche.view.hotcity.dao.CitySqliteOpenHelper;
import com.example.liangjie06.zuche.view.hotcity.view.MyLetterView;
...
public class CityListActivity extends Activity {
    ...
    private void setAdapter() {
        cityListAdapter = new CityListAdapter(this, allCityList,hotCityList, recentCityList, this);
    ...
    private void initView() {
        ...
        lvCity.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                sendCityName(allCityList.get(position).getName());
            }
        });
        ...
        lvResult.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                sendCityName(searchCityList.get(position).getName());
            }
        });
        tvNoResult=(TextView) findViewById(R.id.tv_noresult);
    }
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                if (mReady) {
                    ...
                    if (firstVisibleItem < 4) {
                        ...
                        text = PinYinUtils.converterToFirstSpell(pinyin)
...
//					 延迟一秒后执行，让中间显示的TextView为不可见
    ...
    private void initData() {
        cityOpenHelper=new CitySqliteOpenHelper(this);
    ...
    private ArrayList<City> getCityList() {
        ...
        AllCitySqliteOpenHelper op=new AllCitySqliteOpenHelper(this);
    ...
    public void sendCityName(String str){
        ...
        Log.e("lj", "fanhui");
        CityListActivity.this.setResult(itemId, CityListActivity.this.getIntent().putExtras(bundle));
